...
void ScalarConverter::convert(const std::string& literal) {
	...
	switch (whatIsIt(str)) {
		...
		case TYPE_TOOBIG:
			std::cout << ERR4 "Your input is too big" RESET << std::endl;
			return ;
		case TYPE_INVALID:
