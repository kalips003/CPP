...
Contact::Contact(int how_many_contact) {
	...
	first_name = ft_print_ccat(C_341, C_434, "first_name", how_many_contact, "Enter the first name", 0b110);
	last_name = ft_print_ccat(C_341, C_434, "last_name", how_many_contact, "Enter the last name", 0b110);
	nickname = ft_print_ccat(C_341, C_434, "nickname", how_many_contact, "Enter the nickname", 0b110);
	darkest_secret = ft_print_ccat(C_341, C_434, "darkest_secret", how_many_contact, "Enter the darkest secret", 0b110);
	phone_number = ft_print_ccat(C_341, C_434, "phone_number", how_many_contact, "Enter the phone number", 0b110);
...
void Contact::printData() const {
	// if (!how_many_contact) {
	// 	std::cout << "There is no contact to show !" << std::endl;
	// 	throw 1;
	// }
